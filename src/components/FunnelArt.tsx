...
export function WorldMapIllustration() {
  return (
    <div
      className="mx-auto w-full max-w-sm overflow-hidden rounded-2xl border border-funnel-border bg-funnel-pill p-3"
      role="img"
      aria-label="World map"
    >
      <svg viewBox="0 0 320 160" className="h-auto w-full" fill="none" xmlns="http://www.w3.org/2000/svg">
        <rect width="320" height="160" rx="12" className="fill-funnel-pill" />
        <path
  ...
  return (
    <div className="mx-auto flex w-full max-w-xs justify-center py-2" role="img" aria-label="Ladder toward a goal">
      <svg width="120" height="160" viewBox="0 0 120 160" fill="none" xmlns="http://www.w3.org/2000/svg">
        <rect x="44" y="8" width="32" height="12" rx="4" fill="#f0d78c" stroke="#c9a227" strokeWidth="1.5" />
        <path d="M52 20v132M68 20v132" stroke="#3d5248" strokeWidth="4" strokeLinecap="round" />
        {[36, 56, 76, 96, 116].map((y) => (
          <line key={y} x1="48" y1={y} x2="72" y2={y} stroke="#8fa396" strokeWidth="3" strokeLinecap="round" />
        ))}
        <circle cx="60" cy="14" r="4" fill="#fff8e1" />
      </svg>
    </div>
  );
}
